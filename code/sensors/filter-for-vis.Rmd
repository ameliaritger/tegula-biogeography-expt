...
ggsave(here("figures", "sensors", "smooth_ph.png"), height=20, width=40, units="cm")
...
ggsave(here("figures", "sensors", "smooth_temp.png"), height=20, width=40, units="cm")
```
...
ggplot(raw_combine, aes(x=date_time, y=value, group=group, color=site)) +
  ...
  scale_color_manual(values = pal, #color lines by custom site color palette
                       labels = c("Alegria", "Lompoc Landing", "Bodega Marine \nReserve")) +
...
ggsave(here("figures", "smooth_prospectus.png"), height=20, width=40, units="cm")
```

#Now do the same thing for LOL data 
```{r}
#Read in LOL data
lol_all <- read_csv(here("data","sensors", "lol_all.csv"))
