...
plol_cv <- (lol_sd/lol_mean)*100 #coefficient of variation

tlol_min <- (min(lol_detided$temp_c))
tlol_max <- (max(lol_detided$temp_c))
tlol_median <- (median(lol_detided$temp_c))
tlol_mean <- (mean(lol_detided$temp_c))
tlol_sd <- (sd(lol_detided$temp_c))
